...
An ocean climatology is made up of gridded fields representing the long-term average state of a given variable, for different time periods and at different depth levels. It can be used for model initialisation, data visualisation, and also for informing about the mean state of the ocean over the period of interest. It can be global (i.e., covering the World Ocean) or regional. Most of the ocean climatologies deal with temperature and salinity, while chemical and biological variables are less frequently addressed, often because of the sparser data coverage.
