...
\begin{itemize}
\item spatially: while some regions are densely covered by observations, other regions have been barely sampled (or the existing observations have not made their ways to the NODCs);
