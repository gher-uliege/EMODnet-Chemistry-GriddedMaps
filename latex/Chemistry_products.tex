...
The manuscript is organised according to the following structure: Section~\ref{sec:insitu}: description of the in situ observations; Section~\ref{sec:method}: description of the gridding technique (DIVAnd); Section~\ref{sec:clim}: presentation and validation of the the final products (climatologies). 
